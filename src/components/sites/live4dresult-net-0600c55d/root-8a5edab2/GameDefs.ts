...
export const EAST_LINKS: EastLink[] = [
  { slug: "stc", name: "Sandakan 4D", zh: "STC 4D", logo: L("logo_stc4d.gif?v=1"), href: "/east/stc" },
  { slug: "sabah88", name: "Sabah 88 4D", zh: "Sabah 88", logo: L("logo_sabah88.gif?v=1"), href: "/east/sabah88" },
  { slug: "cashsweep", name: "Cash Sweep 4D", zh: "Cash Sweep", logo: L("logo_cashsweep.gif?v=1"), href: "/east/cashsweep" },
];
