...
export default function GamePager({ initialIndex = 0, name }: { initialIndex?: number; name?: string }) {
  ...
  return (
    <div ref={track}
      ...
      {PAGES.map((pg) => (
        <div key={pg.title} style={{ flex: "0 0 100%", scrollSnapAlign: "start", scrollSnapStop: "always", height: "100%", overflowY: "auto", WebkitOverflowScrolling: "touch", overscrollBehaviorY: "contain", padding: "4px 2px 24px" }}>
